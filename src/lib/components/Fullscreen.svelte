	...
	<div class="button">
		<button class="close" on:click={close} bind:this={closeEl}>
			<svg xmlns="http://www.w3.org/2000/svg" height="48" width="48"
				><path
					d="M26.3 24q-1 0-1.65-.65Q24 22.7 24 21.7v-12q0-.95.65-1.625T26.3 7.4q.95 0 1.625.675T28.6 9.7v6.5L40.25 4.6q.6-.65 1.575-.65t1.575.65q.65.6.65 1.575T43.4 7.75L31.8 19.4h6.5q.95 0 1.625.675T40.6 21.7q0 1-.675 1.65-.675.65-1.625.65ZM4.6 43.4q-.65-.6-.65-1.575t.65-1.575l11.65-11.7h-6.5q-1 0-1.65-.65-.65-.65-.65-1.65 0-.95.65-1.6.65-.65 1.65-.65H21.7q1 0 1.65.65.65.65.65 1.65v11.95q0 1-.65 1.65-.65.65-1.6.65-1 0-1.65-.65-.65-.65-.65-1.65v-6.5L7.75 43.4q-.6.65-1.575.65T4.6 43.4Z"
				/></svg
			>
		</button>
	</div>
